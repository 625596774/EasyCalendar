  ...
  if (executable_path != nullptr) {
    ...
    g_autofree gchar* bundled_icon_path =
        g_build_filename(executable_dir, "data", "flutter_assets", "assets",
                         "EasyCalendar.png", nullptr);
    if (g_file_test(bundled_icon_path, G_FILE_TEST_EXISTS)) {
      gtk_window_set_icon_from_file(window, bundled_icon_path, nullptr);
      return;
    }
  }

  const gchar* source_icon_path = "assets/EasyCalendar.png";
...
static void my_application_activate(GApplication* application) {
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "EasyCalendar");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  } else {
    gtk_window_set_title(window, "EasyCalendar");
  }
